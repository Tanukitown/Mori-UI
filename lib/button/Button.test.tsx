...
describe("Button Component", () => {
  it("renders with default props", () => {
    ...
    expect(button.classList.contains("tui:btn-base")).toBe(true);
    expect(button.classList.contains("tui:btn-primary")).toBe(true);
    expect(button.classList.contains("tui:btn-medium")).toBe(true);
  });
  ...
  describe("Variants", () => {
    ...
    it("renders with neutral variant", () => {
      ...
      expect(button.classList.contains("tui:btn-neutral")).toBe(true);
    });
  });
  ...
  describe("Sizes", () => {
    it("renders with small size", () => {
      ...
      expect(button.classList.contains("tui:btn-small")).toBe(true);
    });
    ...
    it("renders with large size", () => {
      ...
      expect(button.classList.contains("tui:btn-large")).toBe(true);
    });
  });
  ...
  describe("Icons", () => {
    it("renders icon on the left by default", () => {
      ...
      expect(icon?.classList.contains("tui:btn-icon")).toBe(true);
